...
(function() {
    ...
    try {
        ...
        dataLayerDiv.style.cssText = 'position: fixed;left: 86%;top: .6%;padding: 3px;color: black;background-color: ' + color + ';width: 10%;font-size: x-small;opacity: 75%; max-height: 97%; z-index: 9999';
